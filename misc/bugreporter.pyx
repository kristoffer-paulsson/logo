...
class BugReporter(FloatLayout):
    ...
    info_for_user = StringProperty(
        'You can report this bug using the' +
        ' button bellow, helping us to fix it.'
    )
    ...
    icon_background = StringProperty('assets/logo/kivy-icon-256.png')
    ...
    def __init__(self, **kwargs):
        ...
        if not os.path.exists(self.icon_background):
            self.icon_background = 'assets/logo/kivy-icon-256.png'

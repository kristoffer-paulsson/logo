...
from logo.uix.screens import Screens
from logo.uix.dialogs import DialogLoadKvFiles

from kivymd.uix.menu import MDDropdownMenu
from kivymd.uix.fanscreenmanager import MDFanScreen
from kivymd.uix.list import   IRightBodyTouch,  OneLineIconListItem, ThreeLineRightIconListItem
...
<ContentPopup@BoxLayout>
    ...
    Image:
        id: image
        source: f'{environ["LOGO_ASSETS"]}icons/dove-256.png'
        size_hint: 1, None
...
<ContentNavigationDrawer@MDNavigationDrawer>
    drawer_logo: f'{environ["LOGO_ASSETS"]}icons/dove-256.png'
            ...
            ScreenManager:
                ...
                Screen:
                    ...
                    FloatLayout:
                        ...
                        Image:
                            source: f'{images_path}icons/dove-256.png'
                            opacity: .3
...
class LogoMessenger(App, Screens):
    ...
    def __init__(self, **kwargs):
        ...
        self.drawer_item_icons = {
            ...
            "Portfolios": "briefcase-check",
            "Documents": "folder-account",
            "Networks": "domain",
            "Profile": "face-profile",
            "Preferences": "settings",

            # Remove those below when clean up
            "Tests": "test-tube",
        ...
        crop_image(
            ...
            f"{os.environ['LOGO_ASSETS']}icons/dove-256.png",
            f"{os.environ['LOGO_ASSETS']}icons/dove-256.png",
        )
    ...
    def show_demo_shrine(self, instance):
        ...
        path_to_logo = (
            f"{os.environ['KITCHEN_SINK_ROOT']}icons/dove-256.png"
            if self.theme_cls.theme_style == "Dark"
            else f"{os.environ['KITCHEN_SINK_ROOT']}icons/dove-256.png"
        )
        logo = Image(
    ...
    def set_expansion_panel(self):
        ...
        for name_contact in self.names_contacts:
            self.data["Expansion Panel"]["object"].ids.anim_list.add_widget(
                MDExpansionPanel(
                    content=content,
                    icon=f"{os.environ['LOGO_ASSETS']}icons/dove-256.png",
                    title=name_contact,
                )
            )
    ...
    def add_cards(self, instance_grid_card):
        ...
        if not self.cards_created:
            ...
            image_for_card = f"{os.environ['LOGO_ASSETS']}icons/dove-256.png"
    ...
    def show_user_example_animation_card(self):
        ...
        if not self.user_card:
            image_for_user_card = f"{os.environ['LOGO_ASSETS']}icons/dove-256.png"
    ...
    def show_example_grid_bottom_sheet(self):
        ...
        bs_menu.add_item(
            ...
            icon_src=f"{os.environ['LOGO_ASSETS']}icons/dove-256.png",
        )
        bs_menu.add_item(
            "YouTube",
    ...
    def set_list_md_icons(self, text="", search=False):
        ...
        print('Execution: set_list_md_icons')
            ...
            if not self.file_source_code:
                ...
                try:
                    self.data["Source code"][
                        ...
                        f"{os.environ['LOGO_ASSETS']}md/{self.file_source_code}",
                        "rt",
                        encoding="utf-8",
                    ).read()
